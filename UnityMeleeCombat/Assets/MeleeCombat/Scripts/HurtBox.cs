...
namespace MeleeCombatTool
{
    ...
    public class HurtBox
    {
        ...
        [SerializeField] Shape m_shape; // shape of the collider
        [SerializeField] public CombatItem m_owner; // owner of the hurt box
        [SerializeField] public Collider m_collider; // collider 
        [SerializeField] public Vector3 m_center = Vector3.zero; // center of collider
        [SerializeField] public HurtBoxObject m_hurtBoxObject; // monobehaviour reference
        [SerializeField] private Transform m_hurtBoxParentObject; // parent transform to attach to
        private Material m_hurtBoxMaterial; // debug material for hurtboxes, grabbed from resources

        //box size variables
        [SerializeField] private float m_width = 1, m_height = 1, m_depth = 1;

        //sphere and capsule size variables
        ...
        public HurtBox(Shape shape, Transform parent)
        {
            ...
            //Initialise monobehaviour
            ConstructHurtbox();
        }

        //Initialise HurtBoxObject Monobehavour with hurt box values
        ...
        //Updates the size of the Debug mesh, enefficient but needed to go in
        ...
        //Used to scale the debug mesh of a hurt box
        ...
        //Destroys the hurt box object attached to the hurt box
        public void DestroyHurtBox()
        {
            if (m_hurtBoxObject != null)
            {
                m_hurtBoxObject.DestroyHurtBox();
            }
        }

        //Updates the shape of the hurt box, this impacts collision detection
        ...
        //Utility function to change the size of a hurt box object in real time
